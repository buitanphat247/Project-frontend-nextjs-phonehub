...
export default function IPadsFilters({ onFilterChange, currentFilters, brands, loadingBrands = false }: FiltersProps) {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      {/* Search */}
      <div className="mb-6">
        <label htmlFor="ipads-search-input" className="block text-sm font-medium text-gray-700 mb-2">
          Tìm kiếm
        </label>
        <input
          id="ipads-search-input"
          name="search"
          type="text"
