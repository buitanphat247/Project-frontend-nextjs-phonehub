...
import PhonesFilters from "./components/PhonesFilters";
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <PhonesFilters onFilterChange={handleFilterChange} currentFilters={filters} brands={brands} loadingBrands={searching} />
          </div>
