...
export default function CreateRankModal({ visible, onClose, onSubmit }: CreateRankModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Form.Item
          label={<span>Tên xếp hạng <span className="text-red-500">*</span></span>}
          name="name"
          rules={[{ required: true, message: 'Vui lòng nhập tên xếp hạng' }]}
        >
          <Input 
            placeholder="Nhập tên xếp hạng (vd: Đồng, Bạc, Vàng, Bạch kim, Kim cương)" 
            autoComplete="off"
          />
        </Form.Item>
        <Form.Item
          label={<span>Điểm tối thiểu <span className="text-red-500">*</span></span>}
          name="minPoints"
          rules={[
        ...
        <Form.Item
          label={<span>Điểm tối đa <span className="text-red-500">*</span></span>}
          name="maxPoints"
        ...
        <Form.Item
          label={<span>Phần trăm giảm giá (%) <span className="text-red-500">*</span></span>}
